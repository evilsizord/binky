...
define('BINKYDIR', dirname(__FILE__));

class Binky
{
    private $buffer;
    private $defaultConfigFile = 'default.config.php';
    private $config;
    ...
    public function __construct($config = 'default')
    {
        ...
        if ($config == 'default') {
            // Included config file returns a BinkyConfig array
            $this->config = include_once (BINKYDIR . DIRECTORY_SEPARATOR . $this->defaultConfigFile);
        }
